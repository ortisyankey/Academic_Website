...
<h2>Small area population estimates using random forest top-down disaggregation: An R tutorial</h2>

WorldPop, University of Southampton  

20 January 2021  

> **Note:** The example data for this chapter (`master_train.csv` and `master_predict.csv`) can be downloaded from [http://doi.org/10.5258/SOTON/WP00697](http://doi.org/10.5258/SOTON/WP00697){target="_blank"}.  
